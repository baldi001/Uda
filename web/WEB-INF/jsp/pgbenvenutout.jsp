...
<html>
    ...
    <body>
        ...
        <h1> Menù Utente </h1>
            <button style="width: 280px;height: 40px;margin-top: 85px;font-size: 15px;" type="button" onclick="window.location.href='goSegnalazione'">Segnala un problema</button> 
            <br>
